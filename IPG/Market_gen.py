...
def parse_args():
    ...
    parser.add_argument("--query_dir", type=str, default="/root/autodl-tmp/datasets/market1501_less/query_less")
    parser.add_argument("--bound_box_test_dir", type=str, default="/root/autodl-tmp/datasets/market1501_less/bounding_box_test_less")
    parser.add_argument("--ckpt_dir", type=str, default="/root/autodl-fs/ipg_trained_model_05-08/checkpoint-3000")
    ...
    parser.add_argument("--color_json", type=str, default="/root/autodl-tmp/datasets/market1501_less/clothing_colors_less_nl.json")
